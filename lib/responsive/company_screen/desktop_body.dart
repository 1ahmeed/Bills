...
class DesktopCompanyScreen extends StatefulWidget {
  const DesktopCompanyScreen({
    super.key,
  });

  @override
  State<DesktopCompanyScreen> createState() => _DesktopCompanyScreenState();
}

class _DesktopCompanyScreenState extends State<DesktopCompanyScreen> {
