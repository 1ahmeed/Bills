...
class TabletCompanyScreen extends StatefulWidget {
  const TabletCompanyScreen({
    super.key,
  });

  @override
  State<TabletCompanyScreen> createState() => _TabletCompanyScreenState();
}

class _TabletCompanyScreenState extends State<TabletCompanyScreen> {
